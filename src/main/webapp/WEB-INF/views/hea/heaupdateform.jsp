...
<body id="page-top">
    ...
    <div id="wrapper">
       ...
       <%@include file="../include/includefile/header.jsp"  %>
        ...
        <form action="heaupdateform" method="post">
            <table>
            	<tr>
            		<td><input type="hidden" name= "id" value=${hea.id }></td>
            	</tr>
                <tr>
                    <td class="boardtitle">게시글 제목</td>
                    <td><input type="text" name="title" value=${hea.title }></td>
                </tr>
                <tr>
                    <td class="boardtitle">게시글 내용</td>
                    <td><textarea class="boardcontent" name="content" value=${hea.content }></textarea></td>
                </tr>
                <tr>
