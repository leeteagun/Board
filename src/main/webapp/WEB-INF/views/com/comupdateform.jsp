...
<body id="page-top">
    ...
    <div id="wrapper">
       ...
       <%@include file="../include/includefile/header.jsp"  %>
        ...
        <form action="comupdateform" method="post">
            	<input type="hidden" name= "id" value=${com.id }>
            <table>
                <tr>
                    <td class="boardtitle">게시글 제목</td>
                    <td><input type="text" name="title" value=${com.title }></td>
                </tr>
                <tr>
                    <td class="boardtitle">게시글 내용</td>
                    <td><textarea class="boardcontent" name="content" value=${com.content }></textarea></td>
                </tr>
                <tr>
