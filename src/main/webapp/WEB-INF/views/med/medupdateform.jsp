...
<body id="page-top">
    ...
    <div id="wrapper">
       ...
       <%@include file="../include/includefile/header.jsp"  %>
        ...
        <form action="medupdateform" method="post">
            <table>
            	<tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="title" value=${med.title }></td>
                </tr>
                <tr>
                    <td class="boardtitle">게시글 내용</td>
                    <td><textarea class="boardcontent" name="content" value=${med.content }></textarea></td>
                </tr>
                <tr>
